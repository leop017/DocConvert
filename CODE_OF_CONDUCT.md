...
repository (issues, pull requests, discussions, code reviews), the PyPI
project page, and any other official DocConvert channel. It also applies
...
reported to the community leaders responsible for enforcement through any
of the private channels listed in [`SECURITY.md`](./SECURITY.md). All
...
individual, or aggression toward or disparagement of the classes of the
community.
